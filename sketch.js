...
ninHouse = new Ninja4(650,255,150,200);
  ...
  PCB2 = new Detective2();
  gold = new Gold();
  log1 = new Log(500,300);
  log2 = new Log(300,300);
  log3 = new Log(100,300);
  log4 = new Log(800,300);
  var r = Math.round(random(300,1000));
      ...
      treasure3.display();
       ...
       PCA1.velocityX = 3;
        ...
        function richman4(){
          ...
          fill("black");
          textSize(20);
          text("*yawn* what a good nice day outside, I think I'll take a walk... WHERE'S IS MY TREASURE",400, 300);
          fill("black");
          textSize(10);
        ...
        function richman6(){
          ...
          fill("purple");
          textSize(30);
          text("Press Y or y to continue", 400, 200);
          fill("purple");
          textSize(15);
        ...
        function start1(){
          ...
          wall=Bodies.rectangle(100,200,50,1000,option1);
          ...
          if(PCB2.x > log1.width / 2 &&
            log1.x > PCB2.width / 2 &&
            PCB2.y > log.height / 2 &&
            log1.y > PCB2.height / 2){
              gameState = STEP7;
            } 
